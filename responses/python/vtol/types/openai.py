...
OpenAIToolChoice = Union[
    ...
    Annotated[
        Union[
            ...
            # TODO: Enable MCP tool choice once supported
            # OpenAIMcpToolChoice,
        ],
        Discriminator("type"),
    ],
...
vLLMResponsesTool = Annotated[
    vLLMResponsesCodeTool | OpenAIResponsesFunctionTool,
    Field(discriminator="type", description="The type of tool."),
]
OpenAIResponsesTool = Annotated[
    OpenAIResponsesWebSearchTool | OpenAIResponsesCodeTool | OpenAIResponsesFunctionTool,
    Field(discriminator="type", description="The type of tool."),
]
...
class vLLMResponsesRequest(BaseModel):
    ...
    tool_choice: Annotated[
        ...
        Field(
            description=(
                ...
                "Alternatively, you can provide an `allowed_tools` object to constrain the model to a specific set of tools."
            ),
        ),
    ] = "auto"
    tools: Annotated[
    ...
    def as_run_settings(self) -> tuple[dict[str, Any], list[Tool]]:
        """
        ...
        toolsets: list[FunctionToolset | ExternalToolset] = []
        if builtin_tools:
