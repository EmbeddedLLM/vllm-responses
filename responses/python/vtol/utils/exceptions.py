...
@docstring_message
class ContextOverflowError(VtolException):
    """Model's context length has been exceeded."""


@docstring_message
class UnexpectedError(VtolException):
    """We ran into an unexpected error."""


@docstring_message
class RateLimitExceedError(VtolException):
...
@docstring_message
class UnavailableError(VtolException):
    """The requested functionality is unavailable."""


@docstring_message
class ServerBusyError(VtolException):
    """The server is busy."""


@docstring_message
class ModelOverloadError(VtolException):
...
def handle_exception(
    ...
    *,
    ...
    Raises:
        VtolException: If `VtolException` is raised.
    ...
    def _default_handler(e: Exception, *args, **kwargs):
        ...
        #     raise RequestValidationError(errors=e.errors()) from e
            ...
            if request:
                request_id = request.state.vtol.id
