...
from vtol.observability.metrics import record_tool_call_requested
...
class PydanticAINormalizer:
    ...
    def __init__(self, *, builtin_tool_names: set[str], code_interpreter_tool_name: str) -> None:
    ...
    def _on_function_tool_result(
        ...
        if item_key:
            raw = (
                event.result.model_response_str()
