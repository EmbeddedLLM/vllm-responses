...
class EnvConfig(BaseSettings):
    ...
    # Config
    # db_path: str = "postgresql+psycopg://vllm:vllm@pgbouncer:5432/vllm_responses"
    ...
    mcp_builtin_runtime_url: str | None = None
    mcp_request_remote_enabled: bool = True
    mcp_request_remote_url_checks: bool = True
    mcp_hosted_startup_timeout_sec: float = Field(default=10.0, gt=0)
    mcp_hosted_tool_timeout_sec: float = Field(default=60.0, gt=0)
